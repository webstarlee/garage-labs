            ...
            <div class="media media-visible pd-right">
                ...
                <div class="media-body">
                    ...
                    <div class="btn-block text-center col-thumb" style="margin-top:-5px; ">
                        ...
                        <template v-if="data.city && data.city.country">
                            <i class="glyphicon glyphicon-map-marker"></i> {{ data.city ? data.city.name : '' }}, {{ data.city.country ? data.city.country.name : '' }}<br>
                        </template>
